...
class LibraryInventoryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateBook = channel.unary_unary(
                '/inventory.LibraryInventory/CreateBook',
        ...
        self.GetBook = channel.unary_unary(
                '/inventory.LibraryInventory/GetBook',
...
class LibraryInventoryServicer(object):
    """Service to define rpcs related to inventory
    """
...
def add_LibraryInventoryServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'inventory.LibraryInventory', rpc_method_handlers)
...
class LibraryInventory(object):
    ...
    def CreateBook(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/inventory.LibraryInventory/CreateBook',
    ...
    def GetBook(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/inventory.LibraryInventory/GetBook',
